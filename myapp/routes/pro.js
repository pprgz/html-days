    ...
    production.find({}, (err, data) => {
        ...
        res.render("pro", {
            ...
            data: [{
                ...
                column: "搜索",
                brand: "百度",
                logo: "https://www.baidu.com/img/sjdhdong_2f0815641b0fb86e10289d06a632f3f1.gif",
                proImg: "https://www.baidu.com/img/sjdhdong_2f0815641b0fb86e10289d06a632f3f1.gif",
                price: "199",
                introduce: "最好用的手机",
                stock: "99",
                discount: "9",
        ...
        router.get("delete", function(req, res, next) {
            ...
            production.findOneAnDelete({ '_id': req.query._id }, (err, data) => {
                if (err) {
                    console.log(err);
                }
                console.log(data);
